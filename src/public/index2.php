...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">DAW SL</a>
           
              <a class="nav-link js-scroll-trigger" href="">Bienvenido <strong><?php echo $_SESSION['Login'];?></strong></a>
          ...
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#contact">Contacto</a>
                    ...
                    <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="close.php">Desconectar</a>
